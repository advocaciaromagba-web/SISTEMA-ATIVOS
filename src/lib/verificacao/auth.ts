  ...
  providers: [
    CredentialsProvider({
      ...
      async authorize(credentials) {
        ...
        const interno = await autorizarAdminNaSolucao("VERIFICACAO_DOCUMENTOS", credentials);
        if (interno) {
          ...
          return {
            ...
            name: interno.nome,
            email: interno.email,
            verificacaoContaId: interno.contaId,
            papel: interno.papel,
          };
        }
        ...
        if (usuario.verificacaoConta.bloqueadoEm) {
