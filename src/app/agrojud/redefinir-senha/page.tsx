...
export const metadata: Metadata = { title: "Redefinir senha — Agrojud" };

export default async function RedefinirSenhaAgro(props: { searchParams: Promise<{ token?: string }> }) {
      ...
      <div className="w-full max-w-sm">
        ...
        {token ? (
          ...
          <div className="cartao space-y-4 text-sm text-slate-700">
            ...
            <Link href="/agrojud/esqueci-senha" className="botao-principal block w-full text-center">
              Esqueci minha senha
            </Link>
          </div>
        )}
