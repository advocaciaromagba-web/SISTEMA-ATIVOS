...
export const metadata: Metadata = { title: "Esqueci minha senha — Compliance" };

export default function EsqueciSenhaCompliance() {
  return (
    <main className="faixa-escura flex min-h-screen items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <p className="mt-5 text-center text-sm text-white/60">
          <Link href="/compliance/entrar" className="font-medium text-white underline">
            Voltar para o login
          </Link>
        </p>
      </div>
