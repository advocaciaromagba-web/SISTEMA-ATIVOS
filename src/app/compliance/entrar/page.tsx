  ...
  return (
    <main className="faixa-escura flex min-h-screen items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <FormularioEntrarCompliance />

        <p className="mt-5 text-center text-sm text-white/60">
          Ainda não tem conta?{" "}
          <Link href="/compliance/cadastro" className="font-medium text-white underline">
            Assine a solução
          </Link>
        </p>
        <p className="mt-2 text-center text-xs text-white/40">
          <Link href="/compliance/esqueci-senha" className="underline">
            Esqueci minha senha
          </Link>{" "}
          ·{" "}
