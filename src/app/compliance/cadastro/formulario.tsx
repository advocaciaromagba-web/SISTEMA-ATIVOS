...
import { criarContaCompliance, type ResultadoCadastro } from "./acoes";
...
const FORMAS_COBRANCA = [
  ...
  { valor: "CREDITO", nome: "Crédito pré-pago", descricao: "Carrega um saldo e cada verificação desconta do saldo, sem mensalidade." },
  { valor: "AVULSO", nome: "Avulso", descricao: "Paga só quando usa, sem saldo nem mensalidade." },
];

export function FormularioCadastroCompliance() {
  const [estado, acao] = useActionState(criarContaCompliance, inicial);
