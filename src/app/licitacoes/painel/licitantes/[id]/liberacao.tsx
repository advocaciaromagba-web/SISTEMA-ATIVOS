 ...
 */
export function LiberacaoLicitante({
  licitanteEmpresaId,
  bloqueada,
  ehDono,
  liberacao,
  ...
  function rebloquear() {
    setErro("");
    iniciar(async () => {
      const r = await rebloquearLicitante(licitanteEmpresaId);
    ...
    return (
      <div className="aviso-erro mt-3">
        ...
        <span className="mt-1 block">
          Enquanto bloqueada, esta empresa não deve receber envelope novo sem revisão manual.
        </span>
        {ehDono && !abrir && (
